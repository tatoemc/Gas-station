            ...
            <div class="dropdown user-pro-body">
                <div class="">
                    <img alt="user-img" class="avatar avatar-xl brround"
                        src="{{ asset('images/' . Auth::user()->images) }}"><span
        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                    ...
                    </svg><span class="side-menu__label">المواقع</span><i class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ route('locations.index') }}">عرض</a></li>
                </ul>
            </li>
             ...
             <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ route('stations.index') }}">عرض</a></li>
                    <li><a class="slide-item" href="{{ route('stations.create') }}">اضافة</a></li>
                    <li><a class="slide-item" href="{{ route('feeds.create') }}">تغذية المحطات</a></li>
                </ul>
            </li>
             ...
             <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                        ...
                        <path
                            d="M21 6h-2v9H6v2c0 .55.45 1 1 1h11l4 4V7c0-.55-.45-1-1-1zm-5 7c.55 0 1-.45 1-1V3c0-.55-.45-1-1-1H3c-.55 0-1 .45-1 1v14l4-4h10zM4.59 11.59l-.59.58V4h11v7H5.17l-.58.59z" />
                    </svg><span class="side-menu__label">الناقلات</span><i class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ route('tankers.index') }}">عرض</a></li>
                    <li><a class="slide-item" href="{{ route('tankers.create') }}">اضافة</a></li>
                </ul>
            </li>
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ route('reports.create') }}">تقارير عامة</a></li>
                    <li><a class="slide-item" href="{{ url('feed') }}">تغذية المحطات</a></li>
                </ul>
            </li>
