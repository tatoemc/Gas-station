            ...
            <div class="card-body">
                    ...
                    <div class="row mg-b-20">
                        ...
                        <div class="parsley-input col-md-6 mg-t-20 mg-md-t-0" id="lnWrapper">
                            ...
                            <select name="city" id="select-beast" class="form-control  nice-select  custom-select">
                             <option value="الخرطوم"{{ $location->city == 'الخرطوم' ? 'selected' : ''}}>الخرطوم</option>
                             <option value="بحري"{{ $location->city == 'بحري' ? 'selected' : ''}}>بحري</option>
                             <option value="ام درمان"{{ $location->city == 'ام درمان' ? 'selected' : ''}}>ام درمان</option>
                            </select>
                        </div>
                    </div>
                ...
                <div class="row row-sm mg-b-20">
                    <div class="parsley-input col-md-6" id="fnWrapper">
                            ...
                            {!! Form::text('square', null, array('class' => 'form-control','required')) !!}
                    </div>
                    <div class="col-lg-6">
                         <label for="message-text" class="col-form-label">ملاحظات:</label>
                         <textarea class="form-control" id="desc" name="desc">{{ $location->desc }}</textarea>
                    </div>
                </div>
                <div class="mg-t-30">
