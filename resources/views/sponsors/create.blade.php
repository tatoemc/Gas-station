                    ...
                    <form action="{{ route('sponsors.store') }}" method="post" enctype="multipart/form-data"
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" placeholder="ادخال الاسم" id="name" name="name" value="{{ old('name') }}" required>
                            </div>
                            ...
                            <div class="col">
                                ...
                                <input class="form-control" name="password" value="{{ old('password') }}" placeholder="ادخال كلمة المرور"
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input class="form-control" value="{{ old('phone') }}" name="phone" placeholder="ادخال رقم الهاتف"
                                    type="text" required>
                            </div>

                            <div class="col">
                                <label for="add" class="control-label">العنوان</label>
                                <select name="add" id="add" class="form-control" value="{{ old('add') }}" required>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input type="text" class="form-control" value="{{ old('ssn') }}" id="ssn" name="ssn" placeholder="ادخل الرقم الوطني" required>
                            </div>

                            <div class="col">
                              <label for="bank_account" class="control-label">الحساب البنكي</label>
                                <input type="text" class="form-control" value="{{ old('bank_account') }}" id="bank_account" name="bank_account" placeholder="اختياري">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <textarea class="form-control" value="{{ old('note') }}" id="exampleTextarea" name="note" rows="3"></textarea>
                            </div>
                        </div><br>
