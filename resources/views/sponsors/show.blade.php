                                ...
                                <div class=" tab-menu-heading">
                                    <div class="tabs-menu1">
                                        ...
                                        <ul class="nav panel-tabs main-nav-line">
                                            <li><a href="#tab4" class="nav-link active" data-toggle="tab">{{$sponsor->user->name}}</a></li>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @can('isAdmin')
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                <a href=" {{ route('sponsors.index')}} " class="btn btn-lg btn-block btn-primary">رجوع</a>
