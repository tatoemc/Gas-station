        ...
        <div class="col-lg-12 col-md-12">
            ...
            <div class="card-body">
                ...
                <form class="parsley-style-1" id="selectForm2" autocomplete="off" name="selectForm2"
                    action="{{route('stations.store')}}" method="post">
                    {{csrf_field()}}
                    ...
                    <div class="">
                        ...
                        <div class="row mg-b-20">
                            ...
                            <div class="parsley-input col-md-6 mg-t-20 mg-md-t-0" id="lnWrapper">
                                <label>سعة المحطة: <span class="tx-danger">*</span></label>
                                <input class="form-control form-control-sm mg-b-20"
                        ...
                        <div class="row mg-b-20">
                            <div class="parsley-input col-md-6" id="fnWrapper">
                                ...
                                <select class="form-control" name="location_id" required>
                                 <option value="" selected disabled> -- اختيار  الموقع--</option>
                            ...
                            <div class="parsley-input col-md-6" id="fnWrapper">
                                <label> العامل: <span class="tx-danger">*</span></label>
                                <select class="form-control" name="user_id" required>
                                 <option value="" selected disabled> -- اختيار  العامل--</option>
