...
@section('content')
            ...
            <div class="card mg-b-20">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <a class="btn btn-primary btn-sm" href="{{ route('stations.create') }}">اضافة </a>
                                        ...
                                        <td>
                                             <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu tx-13">
                                                    ...
                                                    <a class="dropdown-item"  href="{{ route('stations.edit', $station->id) }}">
                                                        <i class="text-success fas fa-pen-alt"></i>&nbsp;&nbsp;تعديل
                                                    </a>


                                                    <a class="dropdown-item" data-id="{{ $station->id }}"
                                                        data-toggle="modal" data-target="#station_delete">
    ...
    <!-- row closed -->
     <!-- delete -->
    <div class="modal" id="station_delete">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content modal-content-demo">
                <div class="modal-header">
                 ...
                 <form action="{{ route('stations.destroy', 'destroy') }}" method="post">
                    {{ method_field('delete') }}
                    {{ csrf_field() }}
...
@section('js')
    ...
    <script>
    $('#station_delete').on('show.bs.modal', function(event) {
        var button = $(event.relatedTarget)
        var id = button.data('id')
        var modal = $(this)
        modal.find('.modal-body #id').val(id);
