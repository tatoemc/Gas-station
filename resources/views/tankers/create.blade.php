        ...
        <div class="col-lg-12 col-md-12">
            ...
            <div class="card-body">
                ...
                <form class="parsley-style-1" id="selectForm2" autocomplete="off" name="selectForm2"
                    action="{{route('tankers.store')}}" method="post">
                    {{csrf_field()}}
                        ...
                        <div class="row mg-b-20">
                            <div class="parsley-input col-md-6" id="fnWrapper">
                                ...
                                <input class="form-control form-control-sm mg-b-20"
                                    data-parsley-class-handler="#lnWrapper" name="car_number" required="" type="text" value="{{ old('car_number') }}">
                            </div>

                            <div class="parsley-input col-md-6 mg-t-20 mg-md-t-0" id="lnWrapper">
                                <label>سعة الناقلة: <span class="tx-danger">*</span></label>
                                <input class="form-control form-control-sm mg-b-20"
                                    data-parsley-class-handler="#lnWrapper" name="capacity" required="" type="text" value="{{ old('capacity') }}">
                            </div>
                        </div>
                        <div class="row mg-b-20">
                            <div class="parsley-input col-md-6" id="fnWrapper">
